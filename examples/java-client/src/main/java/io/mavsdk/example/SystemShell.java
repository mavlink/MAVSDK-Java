...
public class SystemShell {
  ...
  private static final BufferedReader BUFFERED_READER = new BufferedReader(new InputStreamReader(java.lang.System.in));
  ...
  public static void main(String[] args) {
    ...
    while (true) {
      ...
      if (command.equalsIgnoreCase(CMD_EXIT)) break;
