...
MAVSDK-Java is built using gradle, but `protoc-gen-mavsdk` v2 must be in your PATH in order to auto-generate the code. It can be installed using:

```sh
pip3 install "protoc-gen-mavsdk~=2.0"
```
